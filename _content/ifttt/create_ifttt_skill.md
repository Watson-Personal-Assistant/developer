...
### About this task
The IFTTT skill boilerplate uses an dedicated ifttt nlu.  You must not change the nlu type in the manifest file of the skill.
...
3. In the skilll manifest file, `./res/assets/manifest.json`, specify the following parameters:
