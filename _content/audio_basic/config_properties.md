---
title: Configuraiton properties
weight: 20
---
...
| `logAdditionalAudioInfo`  | If set to `true`, log information about the size of the audio packets and the time that is taken to receive them. | Logging parameter |
