...
Example: `[What|How] is the weather`<br>
...
Example: `What is the [current|] weather`<br>
The expression matches the following utterances:<br>
...
Example: `What is the current weather in {location}`<br>
...
Example: `"What is the horoscope [for|] [{@sunsign}]"`<br>
The expression matches the following utterances:<br>
...
Example: `"$ play {track_name} [by|] [{band_name}]"`<br>
The expression matches the following utterances:<br>
